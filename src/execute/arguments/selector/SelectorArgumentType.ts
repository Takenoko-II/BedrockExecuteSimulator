...
export const SelectorArgumentTypeModel: TypeModel<SelectorArgumentType<unknown>> = sentry.structOf({
    invertible: sentry.boolean,
    duplicatable: sentry.enumLikeOf(SelectorArgumentDuplicationRule),
    type: sentry.classOf(TypeModel)
});
